...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes." ".$seccion;?>"><div class="node-inner">
   <div class="cover"><?=$node->field_fotos[0]['view']?></div>
    <h2 class="title">
      <?php print $title; ?>
    </h2>
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
  ...
  <div class="content">
    ...
    <?php 
    $crels = $node->field_relaciones_gal;
    ...
    $(document).ready(function(){
      $('#page').addClass('page-seccion-galeria');
    });
    </script>
    <?}?>
  </div>
  
  <a href="javascript:history.go(-1);" class="back_home" style="color: #FFFFFF;">&laquo; regresar</a>

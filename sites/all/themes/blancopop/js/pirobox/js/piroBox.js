...
$('body').append(
      ...
      mySpeed: 500,   
      bg_alpha: 0.7,  
      pathLoader : 'url(http://www.blancopop.com/sites/all/themes/blancopop/js/pirobox/css_pirobox/ajax-loader_w.gif) center center no-repeat;',   
      gallery : 'ul.galleria_cw li a',   
      gallery_li : 'ul.galleria_cw li',
      next_class : '.next',  
